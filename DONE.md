...
| [`DONE/reference-data.md`](DONE/reference-data.md) | Exchanges, listings, accounts, holding accounts, ticker/exchange-code renames, price-collection gaps, deployed-database cleanups | 14 |
