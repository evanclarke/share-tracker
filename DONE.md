...
| [`DONE/reporting.md`](DONE/reporting.md) | Portfolio/gains/tax reports, snapshots, performance metrics, tax-return export | 26 |
| [`DONE/tax-domain.md`](DONE/tax-domain.md) | ATO-cited CGT/tax calculation rules — discount, cost base, corporate actions, FITO, franking | 31 |
...
| [`DONE/reviews.md`](DONE/reviews.md) | Code/design review findings and their resolutions | 27 |
