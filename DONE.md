...
| --- | --- | --- |
| [`DONE/infra.md`](DONE/infra.md) | Infrastructure setup, FX/MIC/currency reference-data imports, backups, scheduler, the append-only audit trail, packaging/CI, authentication | 35 |
...
| [`DONE/reporting.md`](DONE/reporting.md) | Portfolio/gains/tax reports, snapshots, performance metrics, tax-return export | 41 |
| [`DONE/tax-domain.md`](DONE/tax-domain.md) | ATO-cited CGT/tax calculation rules — discount, cost base, corporate actions, FITO, franking | 49 |
...
| [`DONE/reviews.md`](DONE/reviews.md) | Code/design review findings and their resolutions | 104 |
