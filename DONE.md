...
| --- | --- | --- |
| [`DONE/infra.md`](DONE/infra.md) | Infrastructure setup, FX/MIC/currency reference-data imports, backups, scheduler, the append-only audit trail, packaging/CI, authentication | 31 |
