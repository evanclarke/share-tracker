...
| [`DONE/api.md`](DONE/api.md) | The HTTP/REST API surface — the 2026-09-24 audit's contract corrections, consistency fixes, machine-client contract, and API-improvement items | 2 |
