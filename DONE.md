...
| [`DONE/api.md`](DONE/api.md) | The HTTP/REST API surface — the 2026-09-24 audit's contract corrections, consistency fixes, machine-client contract, and API-improvement items | 1 |
...
| [`DONE/reviews.md`](DONE/reviews.md) | Code/design review findings and their resolutions | 138 |
| [`DONE/verification-passes.md`](DONE/verification-passes.md) | The pass-by-pass narrative of driving SCENARIOS.md, moved off the top of TODO.md — a summary of SCENARIOS.md's own findings blocks, not the maintained record | 12 |
