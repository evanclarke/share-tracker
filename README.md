...
- **Performance report** — investment performance (not tax) per holding and overall: total return (AUD and % of invested), annualised money-weighted return (IRR over the dated cash flows), and trailing-12-month income yield, valued with supplied prices as at a chosen date; holding-account transfers and rollover exchanges don't distort the portfolio-level figures
