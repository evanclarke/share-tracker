# Verification passes — the closing narrative moved out of TODO.md

This file holds the prose that stood at the top of [TODO.md](../TODO.md) while the last sections
were being closed: the pass-by-pass record of driving [SCENARIOS.md](../SCENARIOS.md) sections
**S through AA**, plus the closing status of the distribution calendar and the 2026-08-25 code
review. It was moved here on **2026-08-28**, when the last section was archived and `TODO.md` had
no open work left — a status preamble on an empty list is a note about the past, and the past
belongs in the archive.

It is a **summary, not the authoritative record.** Every pass below is recorded more fully in two
places that are maintained and should be read first:

- [SCENARIOS.md](../SCENARIOS.md) — its [Verification status](../SCENARIOS.md#verification-status)
  table names the pass that drove each section, and a `### Section <X> findings` block per section
  carries the full account with a finding-to-commit table. This is the record to update; the
  paragraphs below are a condensed copy of it and will not be kept in step.
...
## Closing status: the distribution calendar and the 2026-08-25 code review

**Open: none.** The distribution calendar recorded from REQUIREMENTS 2026-08-27 is closed and
archived in [`DONE/reporting.md`](reporting.md): its research gate — whether the price
...
[`DONE/reviews.md`](reviews.md): the AMIT×rollover pair (`44b8a6b`), the four-endpoint
...
(archived in [`DONE/reviews.md`](reviews.md)): the C2/rollover one, whose reproduction confirmed
...
[`DONE/trades-income.md`](trades-income.md), and summarised with the rest of the pass under
...
## Section T. Jobs, backup, and operations
...
beside a still-`ok` status — all six archived in [`DONE/infra.md`](infra.md).
...
## Section U. Audit trail and history
...
[`DONE/infra.md`](infra.md).

## Section V. Back-dated and out-of-order entry
...
stored column (`4b579c8`) — both archived in [`DONE/trades-income.md`](trades-income.md); the
...
## Section W. Precision, rounding, and scale
...
Archived in [`DONE/infra.md`](infra.md) (W-a, W-b),
[`DONE/trades-income.md`](trades-income.md) (W-e) and
[`DONE/reporting.md`](reporting.md) (W-c, W-d, W-f), and summarised under
[Section W findings](../SCENARIOS.md#section-w-findings).

## Section X. Transactional integrity and concurrency
...
[`DONE/reporting.md`](reporting.md) (X-a) and [`DONE/infra.md`](infra.md) (X-b), and
...
Y-d — all of them now closed and archived in [`DONE/web-frontend.md`](web-frontend.md),
except Y-e in [`DONE/trades-income.md`](trades-income.md). Two came
...
## Section Z. Composite lifecycle scenarios
...
adjustment entirely, Z-g) — archived in [`DONE/trades-income.md`](trades-income.md),
[`DONE/reporting.md`](reporting.md) and [`DONE/tax-domain.md`](tax-domain.md), and
...
## Section AA. Boundary and out-of-scope scenarios
...
[`DONE/tax-domain.md`](tax-domain.md) (AA-a, AA-b, AA-c, AA-e) and
[`DONE/reporting.md`](reporting.md) (AA-d, AA-f), and summarised under
