...
3. If completed items in TODO.md are not present in the requirements, it's likely the functionality is not needed anymore so make a TODO.md for removing it
