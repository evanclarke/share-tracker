...
also caught and fixed `wash_sales.rs` (`9c2ae3b`) — and the inheritance refactor (`85a255d`). The
two sections below were recorded from observations made while fixing and are the open work.
