...
> Source: https://www.ato.gov.au/forms-and-instructions/attribution-managed-investment-trust-member-annual-statement-standard-distribution-statement-2023/guidance-notes
...
1. **Country of residence on 30 June 2023**

Provide country of residence on 30 June 2023, if known and if other than Australia.
...
## Part B: Summary of 2023 tax return items

Most items are self-explanatory. Items that have raised questions are discussed below. Both the AMMA statement and the SDS recommended formats must align with the AIIR as the tax return will be pre-filled according to what is reported in the corresponding fields in the AIIR. A list of these can be found in [Attachment 2](https://www.ato.gov.au/forms-and-instructions/attribution-managed-investment-trust-member-annual-statement-standard-distribution-statement-2023/additional-statement-information-for-investors?anchor=Attachment2#Attachment2).
...
- A non-AMIT amount can only be a negative amount at items **13L**, **13U**, **20R** or **20M**.

The steps below detail the items, find out what to include or show at these items:

1. **U item 13: Non-primary production – Share of non-primary production income less net capital gains, foreign income and franked distributions** and 
...
Do not show here an investor's share of the net income of the trust that is attributable to net capital gains and foreign income (or, for an AMIT or attribution CCIV sub-fund trust, their member components of those characters).

**AMMA** **statement** – the share of franking credits included in the **Franked distributions from trusts** component will be the **Franking credits (grossed-up)** amount (shown in part C) and may not equal the amount at **Q** item**13** **Share of franking credit from franked dividends**. This may arise where the **Franking credits (grossed-up)** amount is reduced by deductions of the AMIT or attribution CCIV sub-fund trust, however investors may be entitled to a tax offset equal to the full amount of their **Share of the franking credit from franked dividends**.

1. **Y item 13: Other deductions relating to non-primary production income**

Show the total of deductible expenses investors incurred during 2022–23 in relation to the distributions.
...
1. **Q item 13: Share of franking credit from franked dividends**
...
1. **R item 13: Share of credit for tax file number amounts withheld from interest, dividends and unit trust distributions**
...
1. **H item 18: Total current year capital gains** 
...
- A disclaimer must be provided to investors as part of the AMMA statement or SDS. The disclaimer should outline the capital losses applied to each of the capital gains labels (a discount capital gain amount or other amount) disclosed in the table.
- Sufficient information must be provided to enable the investor to report the correct foreign capital gain, then calculate and claim the correct FITO that attaches to the foreign capital gain reported in their Australian tax return.
...
- 
- Providing disclaimers in guidelines – where disclaimers cannot be included at part C, they can be included in the guidelines to the AMMA statement or SDS provided to investors.
  - This method may be adopted where the capital gain is disclosed in part B of the AMMA statement or SDS but no further details are provided. The notification in a cover letter or other effective form of communication needs to clearly state that this information must be accessed by the investor and included in the investor's Australian tax return when reporting their foreign capital gains and calculating the FITO available for any foreign tax paid. It must be provided to the investor along with or around the time the AMMA statement or SDS is provided to the investor. This option may be used where the trustee's software does not accommodate full disclosure of the foreign capital gain in the AMMA statement or SDS.

- 

For further information on claiming the FITO when a foreign capital gain is only partly assessable in Australia, see [ATO ID 2010/175](https://www.ato.gov.au/law/view/document?DocID=AID/AID2010175/00001&PiT=99991231235958) *Foreign income tax offset: entitlement where foreign capital gain is only partly assessable in Australia*
...
- [Guide to capital gains tax 2023](https://www.ato.gov.au/forms-and-instructions/capital-gains-tax-guide-2023)
- [Personal investors guide to capital gains tax 2023](https://www.ato.gov.au/forms-and-instructions/capital-gains-tax-personal-investors-guide-2023) (NAT 4152)
- provide details in the trustee's own explanatory material.
...
The amount at item 20**E** must be greater than or equal to the sum of the amounts at item 20**M** and item 20**R**.
...
The information is necessary for those investors who use the *Application for refund of franking credits for individuals 2023* (NAT 4098) and *Refund of franking credits instructions and application for individuals 2023* (NAT 4105).
...
Where the individual investor has no 2022–23 capital losses or unapplied prior year net capital losses, this figure can be used directly to complete item **18A**.

If the investor has 2022–23 capital losses or unapplied prior year net capital losses that can be applied against their share of these capital gains, they refer to the *Guide to capital gains tax 2023* or *Personal investors guide to capital gains tax 2023* (NAT 4152).
...
The trustee informs the individual investor or interposed entity by, for example:

- additional notes in the AMMA or SDS
- a separate statement or courtesy letter, or
- providing information on their website.

For more information see [CGT discount for affordable housing](https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/property-and-capital-gains-tax/cgt-discount-for-affordable-housing).
...
Show this amount in the Attribution column at **Table 2 – Capital gains** to reconcile the total 2022–23 capital gains amount to be shown at **18H** on the individual tax return. Do not include any amount in the Cash distribution column.
...
**SDS** – the **CGT concession amount** (non-AMIT) is the amount referred to in subsection 104-71(4) of the ITAA 1997, including CGT discount amounts paid to the investor. Do not show frozen indexation amounts paid to the investor as CGT concession amounts on the distribution statement. Show this amount in the Cash distribution column. Do not include the **CGT concession amount** in the Taxable amount column.
...
- represents for 2022–23 the total amount of capital gains attributed **(AMMA statement)** or included in the investor's share of the capital gains **(SDS)**, and
...
**AMIT cost base net amount (AMMA statement)** 
 Under Subdivision 276-H of ITAA 1997 trustees of AMITs and attribution CCIV sub-fund trusts are required to state their reasonable estimate of this amount on the AMMA statement for 2022–23. The trustees may need to include additional fields to separately report the AMIT cost base net amount in respect of each of the investor’s membership interests. The investor's actual AMIT cost base net amount may differ as a result of the investor's particular circumstances.
...
The AMIT cost base reduction amount is the sum of Gross cash distribution (G) and Total tax offsets (E).

AMIT cost base increase amount is the sum of amounts in the Attribution column in the:

- Australian income table at (A), (B), (X)
- Capital gains table at (C)
- Foreign income table at (D)
- Other non-assessable amounts and cost base details table at (F).

1. **Other amounts deducted from trust distributions**
...
Only the deductible expenses component of this amount should feed through to part **B**, tem **13** **Y**.

The **Credit for foreign resident capital gains withholding** **amounts** allows the cash amount to be reconciled in part C. Write there the amount of the entitlement to a share of a credit that is recorded at item **18X**. For more information about foreign resident capital gains withholding, see [Foreign residents and capital gains tax](https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/foreign-residents-and-capital-gains-tax).
...
Continue to: [Additional statement information for investors](https://www.ato.gov.au/forms-and-instructions/attribution-managed-investment-trust-member-annual-statement-standard-distribution-statement-2023/additional-statement-information-for-investors?anchor=Footnotes#Footnotes)
