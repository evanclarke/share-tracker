# ESS — the 30-day rule (sale within 30 days of the deferred taxing point)

> Source: https://www.ato.gov.au/businesses-and-organisations/corporate-tax-measures-and-assurance/employee-share-schemes/in-detail/employer-reporting-requirements/reporting-requirements-for-employers
> Retrieved: 2026-06-12 from the Australian Taxation Office (ato.gov.au), QC 23058, last updated 1 April 2022
> This is a local copy of ATO guidance for reference. The ATO site is authoritative.
> Excerpted: Example 11 (Wyatt), the worked example of the 30-day rule.

---

If an employee disposes of an ESS interest (or the share acquired on exercise of a
right) **within 30 days after the deferred taxing point, the deferred taxing point
becomes the date of that disposal** (the 30-day rule). The market value at the moved
taxing point is what the employee received for the shares, so the assessable discount is
re-measured at the sale — and there is no separate capital gain or loss, because the CGT
cost base resets to that same market value at the same date. The rule can move the
discount from one income year into the next. The employer must give the employee an
amended ESS statement within 30 days of becoming aware of the disposal.
...
On 23 June 2016, Wyatt acquires 400 shares in his employer Pepper Pines Ltd under an
ESS. He pays no consideration for the shares. Wyatt cannot dispose of his shares for
three years and the shares will be forfeited if he ceases employment within three years.
...
Pepper Pines Ltd must now give Wyatt an amended ESS statement within 30 days of becoming
...
On 30 July 2019, Pepper Pines Ltd gives Wyatt an amended ESS statement for the 2019
financial year, removing the discount from tax-deferred schemes. On 12 July 2020,
Pepper Pines Ltd gives Wyatt an ESS statement for the 2020 financial year, including the
