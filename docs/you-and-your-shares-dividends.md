# You and your shares 2025 — dividend income and franking credit entitlement (excerpts)

> Source: https://www.ato.gov.au/law/view/print?DocID=SAV%2FYAYS%2F00001 ("You and your shares 2025")
> Retrieved: 2026-06-06 from the Australian Taxation Office (ato.gov.au)
> This is a local copy of ATO guidance for reference (excerpts of the worked examples
> relevant to this project). The ATO site is authoritative.

---

## Dividend income (Examples 1–2)

### Example 1: payment of dividends

On 15 February 2025, an Australian resident company Coals Tyer Ltd pays John, a resident individual, a fully franked dividend of $700 and an unfranked dividend of $200. John receives the dividend statement from Coals Tyer Ltd.

### Example 2: assessable dividend income

John's assessable income for 2024–25 in respect of the dividend is:

| Dividend | Value $ |
| --- | --- |
| Unfranked dividend received | 200 |
| Franked dividend received | 700 |
| Franking credit | 300 |
| **Total assessable dividend income** | **1,200** |

If these are the only dividends John is paid or credited with for the income year, he can transfer these amounts directly to Dividends in the Income section of his tax return.

## Holding period rule (45 days)

The holding period rule requires you to continuously own shares 'at risk' for at least 45 days (90 days for certain preference shares) to be able to claim the franking tax offset. However, under the small shareholder exemption this rule doesn't apply if your total franking credit entitlement is below $5,000.

The 45-day (or 90-day) period doesn't count the day of acquisition or disposal. You can't count days on which you have 30% or less of the ordinary financial risks of loss and opportunities for gain from owning the shares (e.g. because of hedges, options and futures).

If you acquire shares and you haven't already satisfied the holding period rule before the day on which the shares become ex-dividend, the holding period rule commences on the day after the day on which you acquired the shares. The shares become ex-dividend on the day after the last day on which acquisition of the shares will entitle you to receive the dividend.
