...
currencies ──< exchanges, listings, trades (currency + brokerage_currency), income, amma_statements, corporate_actions (currency + scrip_cash_currency), ess_statements, investment_expenses, inheritances
```
