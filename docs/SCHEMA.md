...
exchange_holidays             Full-closure non-trading days per exchange (settlement skips them; valuation reads the calendar live — see the staleness triggers below)
