...
export const ENTITIES = [
  ...
  },
  {
    ...
    fields: [
      ...
      dt('taxing_point_date', 'Taxing point date', { required: true, hint: 'The deferred taxing point (or acquisition date for a taxed-upfront scheme): sets the assessable year and the vest Buy’s acquisition date. Must be on or after 20 September 1985 — the vest Buy is dated here, and a pre-CGT parcel is outside CGT and not modelled.' }),
