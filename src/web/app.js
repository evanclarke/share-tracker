...
const JOB_DESC = {
  ...
  'price-alert': 'Email an alert for every held listing whose latest stored closing price moved more than the configured threshold (default 5%) from the previous stored close \u2014 a fall as much as a rise, in the listing\u2019s own quote currency. Scheduled after each market close; a move is alerted exactly once however many runs re-find it, and a pair straddling a split or consolidation is skipped rather than reported as a crash that never happened.',
