-- Recreate trades and income with TEXT columns for decimal fields so
-- arbitrary-precision values can be stored without IEEE-754 rounding.
-- The income table is dropped first because it references trades.
